...
This package contains the production code for the COMP0138 Final Year
Project "Blind Inverse Problems with Flow-Based Plug-and-Play Priors". It
extends Martin et al.'s PnP-Flow framework to the blind setting in which
the Gaussian blur parameter is unknown and must be inferred from the
degraded observation alone.

The upstream framework is preserved unmodified. Every file in this
directory is part of the thesis contribution. Attribution and citation
information for Martin et al. is included at the repository root.
